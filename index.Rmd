...
description: 'Lectures for the ICTP-SAIFR/IFT-UNESP *School on Community Ecology:
...
The code is written in `R`, and meant to run using a fairly recent version of `R` along with the packages `tidyverse`, `deSolve`, ... that need to be installed.

## Sources

These notes were prepared by summarizing and interpolating a variety of sources, including @hadeler2017topics, ....
